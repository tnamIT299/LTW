...
namespace Alazea
{
    ...
    public partial class SanPham
    {
        ...
        [RegularExpression(@"^[a-zA-ZÀ-Ỹà-ỹ].*" ,ErrorMessage ="Tên sản phẩm phải bắt đầu bằng 1 chữ cái")]
        ...
        [RegularExpression(@"^\d[0-9]+$", ErrorMessage = "Vui lòng nhập số")]
        public Nullable<long> GiaNhap { get; set; }
      

        [DisplayName("Đơn Giá Nhỏ Nhất")]
        [RegularExpression(@"^\d[0-9]+$", ErrorMessage = "Vui lòng nhập số")]
