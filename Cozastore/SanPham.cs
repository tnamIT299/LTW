...
namespace Cozastore
{
    ...
    public partial class SanPham
    {
        ...
        [RegularExpression(@"^[a-zA-ZÀ-Ỹà-ỹ].*", ErrorMessage = "Tên sản phẩm phải bắt đầu bằng một chữ cái.")]
        ...
        [RegularExpression(@"^[a-zA-ZÀ-Ỹà-ỹ].*", ErrorMessage = "Mô Tả Ngắn phải bắt đầu bằng một chữ cái.")]
        public string MoTaNgan { get; set; }

        [DisplayName("Ảnh Đại Diện")]
        [RegularExpression(@".*\.jpg", ErrorMessage = "Phải là tên file ảnh có chứa .jpg")]
